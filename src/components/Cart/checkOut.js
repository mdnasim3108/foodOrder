...
const Checkout = (props) => {
    ...
    const OrderActions = async (token) => {
        try {
            await axios.post("https://order-servers.herokuapp.com/generateToken", { token, subTotal, items })
                .then(async(res) => {
                    ...
                    axios.post("https://order-servers.herokuapp.com/placeOrder",{OrderId,orderItems,orderAmount,transactionId,shippingAddress,name})
                    .then(()=>{
